defmodule LiveChatWidget.Identity do
  @moduledoc """
  ...
  alias LiveChatWidget.Identity.{User, UserToken, UserNotifier}
  ...
  See `LiveChatWidget.Identity.User.email_changeset/3` for a list of supported options.
  ...
  See `LiveChatWidget.Identity.User.password_changeset/3` for a list of supported options.
